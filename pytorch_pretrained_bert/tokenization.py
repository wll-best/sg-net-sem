...
class BertTokenizer(PreTrainedTokenizer):
    ...
    def __init__(self, vocab_file, do_lower_case=True, do_basic_tokenize=True, never_split=None,
        ...
        self.max_len_single_sentence = self.max_len - 2  # take into account special tokens，新增
        self.max_len_sentences_pair = self.max_len - 3  # take into account special tokens，新增
        ...
        self.do_basic_tokenize = do_basic_tokenize#新增do_basic_tokenize
    ...
    def _tokenize(self, text):
        split_tokens = []
        if self.do_basic_tokenize:#新增do_basic_tokenize
...
class BasicTokenizer(object):
    ...
    def _tokenize_chinese_chars(self, text):
        """Adds whitespace around any CJK（Chinese, Japanese, Korean） character."""
        output = []
        for char in text:
            cp = ord(char)
